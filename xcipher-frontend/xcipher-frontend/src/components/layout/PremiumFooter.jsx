    ...
    <div className="footer-grid">
      ...
      <div>
        ...
        <div className="footer-links">
          ...
          <button className="interactive" onClick={() => onNavigate('integrations')} style={{ background: 'transparent', border: 'none', color: 'var(--text3)', textAlign: 'left', cursor: 'pointer', padding: 0 }}>Integrations</button>
          ...
          <button className="interactive" onClick={() => onNavigate('changelog')} style={{ background: 'transparent', border: 'none', color: 'var(--text3)', textAlign: 'left', cursor: 'pointer', padding: 0 }}>Changelog</button>
        </div>
      </div>
      <div>
        ...
        <div className="footer-links">
          ...
          <button className="interactive" onClick={() => onNavigate('blog')} style={{ background: 'transparent', border: 'none', color: 'var(--text3)', textAlign: 'left', cursor: 'pointer', padding: 0 }}>Blog</button>
          <button className="interactive" onClick={() => onNavigate('status')} style={{ background: 'transparent', border: 'none', color: 'var(--text3)', textAlign: 'left', cursor: 'pointer', padding: 0 }}>Status</button>
        </div>
      </div>
      <div>
